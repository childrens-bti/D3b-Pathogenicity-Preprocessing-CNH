...
id: autogvp_annotate_custom
doc: |
  Tool for the 02-annotate_variants_custom_input.R script from AutoGVP
requirements:
  ...
  - class: DockerRequirement
    dockerPull: 'pgc-images.sbgenomics.com/diskin-lab/autogvp:v1.0.5'
...
outputs:
  annotation_report: { type: 'File', outputBinding: { glob: '*.custom_input.annotations_report.abridged.tsv' }}
